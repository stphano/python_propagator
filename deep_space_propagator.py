...
# #  Create veichle
bodies.create_empty_body("3U-CubeSat")
# set mass
bodies.get_body("3U-CubeSat").set_constant_mass(4.0)
...
environment_setup.add_radiation_pressure_interface(
    bodies, "3U-CubeSat", radiation_pressure_settings)

# # create accelerations
bodies_to_propagate = ["3U-CubeSat"]
central_bodies = ["Sun"]
...
acceleration_settings = {"3U-CubeSat": accelerations_settings_3u_cubesat}
...
dependent_variables_to_save = [
    propagation_setup.dependent_variable.total_acceleration("3U-CubeSat"),
    propagation_setup.dependent_variable.keplerian_state("3U-CubeSat", "Sun"),
]
# create propagation settings
...
save2txt(solution=states,
         filename="PropagationHistory_3U_CubeSat_2.dat",
